				...
				<form action="UserRegisterServlet" method="post">
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<input type="email" class="form-control" id="email"
								name="useremail" value="${ubean.useremail}">
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-md-2"></div>
					...
					<div class="row mb-4">
						...
						<label for="userRole" class="col-md-2 col-form-label">User
							Role</label>
						<div class="col-md-4">
							<select name="role" class="form-select" aria-label="Education"
								id="userRole">
								<option value="${ubean.role}">${ubean.role}</option>
