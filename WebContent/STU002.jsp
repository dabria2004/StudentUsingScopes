...
<body>
    ...
    <div class="sidenav">
        ...
        <button class="dropdown-btn" > Class Management <i class="fa fa-caret-down"></i></button>
          ...
          <a href="USR003.jsp">Student Search </a>
        </div>
    ...
    <div id="sub_content">
        <form action = "StudentUpdateServlet" method = "post">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" value="${data.studentid}" id="studentID" name = "studentid" readonly="readonly">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="name" value="${data.studentname}" name = "studentname">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
...
<input class="form-check-input" type="radio" name="gender" id="gridRadios1" value="${data.gender}">
                        <label class="form-check-label" for="gridRadios1">
                            Male
                        </label>
                    </div>
                    <div class="form-check-inline">
<input class="form-check-input" type="radio" name="gender" id="gridRadios2" value="${data.gender}">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <select class="form-select" aria-label="Education" id="education">
                        <option selected value="${data.education}">Bachelor of Information Technology</option>
                        <option value="${data.education}">Diploma in IT</option>
                        <option value="${data.education}">Bachelor of Computer Science</option>
